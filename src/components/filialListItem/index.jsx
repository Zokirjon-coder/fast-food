...
const FilialListItem = (props) => {
  ...
  const onDelete = (id) => {
    setFilials(filials.filter((filial) => filial.id !== id));
  };
  ...
  return (
    <FilialItem>
      <Flex>
        ...
        <div className="fillialaction">
          <CircleBtn
            ...
            param={{ diametr: "35", borderWidth: "4" }}
          >
          ...
          <CircleBtn
            onClick={() => setShowEditFilial(true)}
            param={{ diametr: "35", borderWidth: "4" }}
          >
            <Flex className="centered">
      ...
      <DrowerLocation
        showLocation={[showLoc, setShowLoc]}
        location={location}
      />
      <DrowerFilial
        input="edit"
        id={id}
        show={[showEditFilial, setShowEditFilial]}
        location={location}
      />
    </FilialItem>
  );
